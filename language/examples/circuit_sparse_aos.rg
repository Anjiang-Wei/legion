...
local primary_variant1 = init_nodes:get_primary_variant()
primary_variant1:add_layout_constraint(
  regentlib.layout.ordering_constraint(terralib.newlist {
    regentlib.layout.field_constraint(
      "rn",
      terralib.newlist {
        regentlib.field_path("node_cap"),
        regentlib.field_path("leakage"),
        regentlib.field_path("charge"),
        regentlib.field_path("node_voltage"),
      }
    ),
...
local primary_variant2 = init_wires:get_primary_variant()
primary_variant2:add_layout_constraint(
  regentlib.layout.ordering_constraint(terralib.newlist {
    regentlib.layout.field_constraint(
      "rw",
      terralib.newlist {
        ...
        regentlib.field_path("current"),
        regentlib.field_path("voltage"),
      }
    ),
    regentlib.layout.dimx,
  })
